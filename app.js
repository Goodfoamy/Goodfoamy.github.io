...
// Pre-order traversal
return Object.defineProperty(e.prototype,"rootNode",{get:function(){return this._rootNode},enumerable:!0,configurable:!0}),e.prototype.traverseNodes=function(e){if(!e)throw new o.default("callback not defined");this.traverseNodesInternal(e,this.rootNode)},e.prototype.traverseNodesInternal=function(e,t){if(e(t),t.children)for(var i=0;i<t.children.length;i++)this.traverseNodesInternal(e,t.children[i])},e.prototype.clone=function(){return new e(this.cloneNode(this.rootNode))},e.prototype.cloneNode=function(e){var t=new n.InternalNode;if(t.name=e.name,t.type=e.type,t.group=e.group,t.parent=void 0,!e.children)return t;for(var i=[],o=0;o<e.children.length;o++){var r=this.cloneNode(e.children[o]);r.parent=t,i.push(r)}return t.children=i,t},e}();t.InternalData=r,Object.defineProperty(t,"__esModule",{value:!0}),t.default=r},/***/
1224:/***/
...
1237:/***/
function(e,t,i){"use strict";var n=this&&this.__decorate||function(e,t,i,n){var o,r=arguments.length,a=r<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,n);else for(var u=e.length-1;u>=0;u--)(o=e[u])&&(a=(r<3?o(a):r>3?o(t,i,a):o(t,i))||a);return r>3&&a&&Object.defineProperty(t,i,a),a},o=i(151),r=i(203),a=i(119),u=i(1),s=function(){function e(){}return e.prototype.convert=function(e){var t=this.preprocess(e);if(""===e)return null;var i,n=new Map;try{i=o.parse(t)}catch(e){return null}var r=this.createNode(i);n.set(i,r);var u=new a.default(r);return i.traverse(function(e,t,i){var o=n.get(e);void 0===o&&(o=this.createNode(e),n.set(e,o));var r=n.get(i);o.parent=r,void 0!==r&&(void 0===r.children&&(r.children=[]),r.children.push(o))}.bind(this)),u},e.prototype.preprocess=function(e){return e.replace("=","==").replace("/(\r\n|\r|\n)/g","")},e.prototype.postprocessOperator=function(e){return e.replace("==","=")},e.prototype.createNode=function(e){var t=new r.InternalNode;switch(e.type){case"ConstantNode":t.name=e.value,t.type=Number.isInteger(+e.value)?3:1,t.group=0;break;case"OperatorNode":t.name=e.op=this.postprocessOperator(e.op),t.type=this.getOperatorType(e),t.group=1;break;case"ParenthesisNode":t.name="()",t.type=4,t.group=2;break;default:t.name="?",t.type=6,t.group=3}return t},e.prototype.getOperatorType=function(e){switch(e.op){case"+":return 0;case"-":return 5;case"=":return 2}},e}();s=n([u.Injectable()],s),t.MathTextInputService=s,Object.defineProperty(t,"__esModule",{value:!0}),t.default=s},/***/
1238:/***/
function(e,t,i){"use strict";var n=this&&this.__decorate||function(e,t,i,n){var o,r=arguments.length,a=r<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,n);else for(var u=e.length-1;u>=0;u--)(o=e[u])&&(a=(r<3?o(a):r>3?o(t,i,a):o(t,i))||a);return r>3&&a&&Object.defineProperty(t,i,a),a},o=i(1),r=function(){function e(){}return e.prototype.convert=function(e){var t=[];return this.processNode(e.rootNode,t),t.join("")},e.prototype.processNode=function(e,t){switch(e.group){case 2:this.processContainerGroupNode(e,t);break;case 0:this.processNumberGroupNode(e,t);break;case 1:this.processOperatorGroupNode(e,t);break;default:this.processUnknownGroupNode(e,t)}},e.prototype.processContainerGroupNode=function(e,t){if(4===e.type){if(t.push("("),e.children)for(var i=0;i<e.children.length;i++)this.processNode(e.children[i],t);t.push(")")}},e.prototype.processNumberGroupNode=function(e,t){t.push(e.name)},e.prototype.processOperatorGroupNode=function(e,t){e.children&&2===e.children.length&&(this.processNode(e.children[0],t),t.push(e.name),this.processNode(e.children[1],t))},e.prototype.processUnknownGroupNode=function(e,t){t.push(e.name)},e}();r=n([o.Injectable()],r),t.MathTextOutputService=r,Object.defineProperty(t,"__esModule",{value:!0}),t.default=r},/***/
1239:/***/
...
1240:/***/
function(e,t,i){"use strict";var n=this&&this.__decorate||function(e,t,i,n){var o,r=arguments.length,a=r<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,n);else for(var u=e.length-1;u>=0;u--)(o=e[u])&&(a=(r<3?o(a):r>3?o(t,i,a):o(t,i))||a);return r>3&&a&&Object.defineProperty(t,i,a),a},o=i(1),r=i(205),a=function(){function e(){this.width=750,this.height=350,this.nodeWidth=40,this.nodeHeight=40,this.nodeHorizontalSpacing=10,this.nodeVerticalSpacing=10}return e.prototype.configure=function(e,t){e&&(e.hasOwnProperty("width")&&(this.width=e.width),e.hasOwnProperty("height")&&(this.width=e.height),e.hasOwnProperty("nodeWidth")&&(this.width=e.nodeWidth),e.hasOwnProperty("nodeHeight")&&(this.width=e.nodeHeight)),t&&(this.eventHandler=t)},e.prototype.construct=function(e,t){var i=this;if(e&&(this.clearNodes(e),t)){
//var processedRootNode = this.preprocessRootNode(internalData.clone().rootNode);
var n=r.hierarchy(t.rootNode);n=this.preprocessRootNode(n),r.cluster().nodeSize([this.nodeWidth+this.nodeHorizontalSpacing,this.nodeHeight+this.nodeVerticalSpacing])(n),this.processHierarchy();var o,a,u=n.descendants(),s=n.links();if(n.children&&n.children.length>0){var l=this.findEdgeLeaf(n.children[0],!0);o=l.x,a=l.y}u.forEach(function(e){if(2===e.data.type){var t=i.findEdgeLeaf(n.children[0],!1),r=i.findEdgeLeaf(n.children[1],!0);t&&r&&(e.x=(t.x+r.x)/2,e.y-=t.y)}else e.y=-e.y;o&&o<0&&(e.x-=o),a&&a>0&&(e.y+=a)});var c=r.select(e.nativeElement).append("svg"),d=c.append("g"),f=this;d.selectAll("line").data(s).enter().each(function(e){f.processLink(e,this)}),d.selectAll("g").data(u).enter().each(function(e){f.processNode(e,this)});var p=d.node();if(p){var b=p.getBBox();c.attr("width",b.width).attr("height",b.height).attr("viewBox","0 0 "+b.width+" "+b.height)}}},e.prototype.clearNodes=function(e){r.select(e.nativeElement).selectAll("*").remove()},e.prototype.preprocessRootNode=function(e){for(var t=[];4===e.data.type&&e.children;)e=e.children[0];for(t.push(e);t.length>0;){var i=t.pop();this.preprocessNode(i,t)}return e},e.prototype.preprocessNode=function(e,t){if(e.children)if(4===e.data.type){var i=e.children[0];i.parent=e.parent,t.push(i);var n=e.parent.children.indexOf(e);e.parent.children.splice(n,1),e.parent.children.splice(n,0,i),e.parent=void 0}else for(var o=0;o<e.children.length;o++)t.push(e.children[o])},e.prototype.processHierarchy=function(){},e.prototype.processNode=function(e,t){switch(e.data.group){case 0:this.processNumberNode(e,t);break;case 1:this.processOperatorNode(e,t);break;case 2:this.processContainerNode(e,t);default:this.processStandardNode(e,t)}},e.prototype.processNumberNode=function(e,t){this.processStandardNode(e,t)},e.prototype.processOperatorNode=function(e,t){this.processStandardNode(e,t)},e.prototype.processContainerNode=function(e,t){this.processStandardNode(e,t)},e.prototype.processStandardNode=function(e,t){var i=r.select(t).append("g").attr("transform",function(e){return"translate("+e.x+","+e.y+")"});i.append("rect").attr("x","0").attr("y","0").attr("width",this.nodeWidth).attr("height",this.nodeHeight).attr("class",this.getRectClassName).on("click",this.onClick.bind(this)),i.append("svg").attr("width",this.nodeWidth).attr("height",this.nodeHeight).attr("viewBox","0 0 60 60").attr("preserveAspectRatio","xMidYMid meet").append("text").attr("font-size",this.getFontSize()).attr("x","50%").attr("y","50%").text(function(e){return e.data.name}).attr("class",this.getTextClassName).on("click",this.onClick.bind(this))},e.prototype.processLink=function(e,t){var i=this;if(!e.source||2!==e.source.data.type){var n=e.source;r.select(t).append("line").attr("x1",function(){return n.x+i.nodeWidth/2}).attr("y1",function(){return n.y+i.nodeHeight/2}).attr("x2",function(){return e.target.x+i.nodeWidth/2}).attr("y2",function(){return e.target.y+i.nodeHeight/2}).attr("class","mirror-mountain-line")}},e.prototype.onClick=function(e){this.eventHandler&&this.eventHandler.selectNode(e.data)},e.prototype.getRectClassName=function(e){return 2===e.data.type?"mirror-mountain-rect-equality":"mirror-mountain-rect"},e.prototype.getTextClassName=function(e){switch(e.data.group){case 0:return"mirror-mountain-text mirror-mountain-text-number";case 1:return"mirror-mountain-text mirror-mountain-text-operator"}},e.prototype.findEdgeLeaf=function(e,t){for(var i=e;i&&i.children;)i=t?i.children[0]:i.children[1];return i},e.prototype.getFontSize=function(){return this.nodeHeight},e}();a=n([o.Injectable()],a),t.MirrorMountainService=a},/***/
1241:/***/
...
366:/***/
function(e,t,i){"use strict";var n=this&&this.__decorate||function(e,t,i,n){var o,r=arguments.length,a=r<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,n);else for(var u=e.length-1;u>=0;u--)(o=e[u])&&(a=(r<3?o(a):r>3?o(t,i,a):o(t,i))||a);return r>3&&a&&Object.defineProperty(t,i,a),a},o=i(1),r=i(66),a=i(38),u=i(19),s=i(206),l=i(370),c=i(1227),d=i(1235),f=i(343),p=i(1230),b=i(1241),h=i(1239),m=i(346),g=function(){function e(){}return e}();g=n([o.NgModule({imports:[r.BrowserModule,u.FormsModule,a.RouterModule.forRoot([{path:"sandbox",component:d.SandboxComponent}]),s.DialogModule,s.ButtonModule,l.BrowserAnimationsModule],declarations:[c.AppComponent,d.SandboxComponent,f.ExpressionComponent,p.ExpressionOperationComponent,b.VisualizationComponent,h.MirrorMountainComponent,m.ModalSuccessComponent],bootstrap:[c.AppComponent],entryComponents:[f.ExpressionComponent]})],g),t.AppModule=g},/***/
368:/***/
function(e,t,i){"use strict";/**
 * @param {?} exp
 * @param {?} errors
 ...
 * @return {?}
 */
function c(e,t,i){":"==e[0]&&(e=d(e,i));var/** @type {?} */n=e.match(/^(\*|[-\w]+)\s*(<?[=-]>)\s*(\*|[-\w]+)$/);if(null==n||n.length<4)return i.push('The provided transition expression "'+e+'" is not supported'),t;var/** @type {?} */o=n[1],/** @type {?} */r=n[2],/** @type {?} */a=n[3];t.push(f(o,a));var/** @type {?} */u=o==q&&a==q;"<"!=r[0]||u||t.push(f(a,o))}/**
 * @param {?} alias
 * @param {?} errors
 * @return {?}
 */
 ...
 * @return {?}
 */
function f(e,t){return function(i,n){var/** @type {?} */o=e==q||e==i,/** @type {?} */r=t==q||t==n;return o&&r}}/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 ...
 * @return {?}
 */
function m(e,t,i,n,o,r,a){return{type:0,triggerName:e,isRemovalTransition:n,fromState:t,fromStyles:o,toState:i,toStyles:r,timelines:a}}/**
 * @param {?} matchFns
 * @param {?} currentState
 * @param {?} nextState
 * @return {?}
 */
function g(e,t,i){return e.some(function(e){return e(t,i)})}/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 ...
 * @return {?}
 */
function v(e){var/** @type {?} */t=Array.isArray(e)?i.i(I.sequence)(/** @type {?} */e):e;return(new K).validate(t)}/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
...
get:function(){throw new Error("...")},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"queuedPlayers",{/**
         * @return {?}
         */
get:function(){throw new Error("...")},enumerable:!0,configurable:!0}),e}(),U=1e3,q="*",L=function(){/**
     * @param {?} errors
     * @param {?} timelines
...
/**
     ...
     * @return {?}
     */
return e.prototype.buildKeyframes=function(e,t,i){var/** @type {?} */n=new L([],[]);n.currentTimeline.setStyles(t),s(this,e,n);
...
function e(e,t,n,o){this._triggerName=e,this.matchFns=n,this._stateStyles=o;var r=Array.isArray(t.animation)?i.i(I.sequence)(t.animation):t.animation;this._animationAst=r}/**
     ...
     * @return {?}
     */
return e.prototype.match=function(e,t){if(g(this.matchFns,e,t)){var/** @type {?} */i=this._stateStyles["*"]||{},/** @type {?} */n=this._stateStyles[e]||i,/** @type {?} */o=this._stateStyles[t]||i,/** @type {?} */r=b(this._animationAst,n,o);return m(this._triggerName,e,t,"void"===t,n,o,r)}},e}(),K=function(){function e(){}/**
     * @param {?} ast
     * @return {?}
     */
/**
...
a=i.startTime),n&&(t.collectedStyles[e]={startTime:a,endTime:r})})},e.prototype.visitKeyframeSequence=function(e,t){var i=this,/** @type {?} */n=0,/** @type {?} */r=[],/** @type {?} */a=!1,/** @type {?} */u=!1,/** @type {?} */s=0;e.steps.forEach(function(e){var/** @type {?} */t=o(e.styles),/** @type {?} */i=0;t.hasOwnProperty("offset")&&(n++,i=t.offset),u=u||i<0||i>1,a=a||i<s,s=i,r.push(i)}),u&&t.errors.push("Please ensure that all keyframe offsets are between 0 and 1"),a&&t.errors.push("Please ensure that all keyframe offsets are in order");var/** @type {?} */l=e.steps.length,/** @type {?} */c=0;n>0&&n<l?t.errors.push("Not all style() steps within the declared keyframes() contain offsets"):0==n&&(c=1/l);var/** @type {?} */d=l-1,/** @type {?} */f=t.currentTime,/** @type {?} */p=t.currentAnimateTimings.duration;e.steps.forEach(function(e,n){var/** @type {?} */o=c>0?n==d?1:c*n:r[n],/** @type {?} */a=o*p;t.currentTime=f+t.currentAnimateTimings.delay+a,t.currentAnimateTimings.duration=a,i.visitStyle(e,t)})},e}(),H=function(){function e(){this.errors=[],this.currentTime=0,this.collectedStyles={}}return e}(),$=function(){/**
     * @param {?} name
     * @param {?} states
...
/**
     ...
     * @return {?}
     */
return e.prototype.createFallbackInstruction=function(e,t){var/** @type {?} */i=this.states["*"]||{},/** @type {?} */n=this.states[e]||i,/** @type {?} */o=this.states[t]||i;return m(this.name,e,t,"void"==t,n,o,[])},e.prototype.matchTransition=function(e,t){for(var/** @type {?} */i=0;i<this.transitionFactories.length;i++){var/** @type {?} */n=this.transitionFactories[i].match(e,t);if(n)return n}},e}(),W=function(){function e(){this.errors=[],this.states={},this.transitions=[]}return e}(),X=function(){function e(){}/**
     * @param {?} name
     * @param {?} definitions
     * @return {?}
     */
...
i.d(t,"ɵe",function(){return g}),/* harmony export (binding) */
i.d(t,"ɵf",function(){return v}),/* harmony export (binding) */
i.d(t,"ɵa",function(){return m}),/* harmony export (binding) */
...
return+e!=e&&(e=0),r.alloc(+e)}function m(e,t){if(r.isBuffer(e))return e.length;if("undefined"!=typeof ArrayBuffer&&"function"==typeof ArrayBuffer.isView&&(ArrayBuffer.isView(e)||e instanceof ArrayBuffer))return e.byteLength;"string"!=typeof e&&(e=""+e);var i=e.length;if(0===i)return 0;for(
// Use a for loop to avoid recursion
var n=!1;;)switch(t){case"ascii":case"latin1":case"binary":return i;case"utf8":case"utf-8":case void 0:return G(e).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return 2*i;case"hex":return i>>>1;case"base64":return H(e).length;default:if(n)return G(e).length;// assume utf8
t=(""+t).toLowerCase(),n=!0}}function g(e,t,i){var n=!1;
...
t.push(255&e.charCodeAt(i));return t}function K(e,t){for(var i,n,o,r=[],a=0;a<e.length&&!((t-=2)<0);++a)i=e.charCodeAt(a),n=i>>8,o=i%256,r.push(o),r.push(n);return r}function H(e){return X.toByteArray(q(e))}function $(e,t,i,n){for(var o=0;o<n&&!(o+i>=t.length||o>=e.length);++o)t[o+i]=e[o];return o}function W(e){return e!==e}/*!
...
958:/***/
function(e,t){e.exports="/*:host /deep/ .chart div {\r\n    font: 10px sans-serif;\r\n    background-color: steelblue;\r\n    text-align: right;\r\n    padding: 3px;\r\n    margin: 1px;\r\n    color: white;\r\n}\r\n\r\n:host >>> .chart text {\r\n  fill: white;\r\n  font: 10px sans-serif;\r\n  text-anchor: end;\r\n}*/\r\n\r\n.mirror-mountain-box {\r\n  overflow: auto;\r\n}\r\n\r\n.mirror-mountain-rect {\r\n  fill: lightskyblue;\r\n  stroke: black;\r\n  stroke-width: 3;\r\n  user-select: none;\r\n  cursor: pointer;\r\n}\r\n\r\n.mirror-mountain-rect-equality {\r\n  fill: lawngreen;\r\n  stroke: black;\r\n  stroke-width: 3;\r\n}\r\n\r\n.mirror-mountain-text {\r\n  font-family: Cambria, Cochin, Georgia, Times, Times New Roman, serif;\r\n  text-anchor: middle;\r\n  fill: black;\r\n  user-select: none;\r\n  cursor: pointer;\r\n}\r\n\r\n.mirror-mountain-text-number {\r\n  dominant-baseline: central;\r\n}\r\n\r\n.mirror-mountain-text-operator {\r\n  dominant-baseline: middle;\r\n}\r\n\r\n.mirror-mountain-text-operator-multiplication {\r\n  dominant-baseline: mathematical;\r\n}\r\n\r\n.mirror-mountain-text-variable {\r\n  dominant-baseline: middle;\r\n}\r\n\r\n.mirror-mountain-line {\r\n  stroke: black;\r\n  stroke-width: 2;\r\n}"},/***/
959:/***/
